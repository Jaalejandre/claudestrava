...
- **Alertas:** si detecta algo mal (guest caído, storage >88%, disco CT >85%, swap alto, UPS en batería, backup fallido, o no puede conectar) manda push a **ntfy** → topic `pve-alerts` (`http://192.168.0.104/pve-alerts`). Suscríbete a ese topic en la app de ntfy.
