...
> **Status:** Recién creado. Código localizado en CT 901 (`/home/alejandre/Programa_DM/`), GPU RTX 5070 Ti confirmada. Falta: montar copia de trabajo con git, compilar línea base con flags de optimización reales (hoy compila en `-O0 -g -fcheck=bounds`), y correr el primer benchmark de referencia.
